...
public interface MailGroupDao extends DaoBase<MailGroup, Long>, QuerydslBinderCustomizer<QMailGroup>
{
	Long countByName(String name);

	MailGroup findTopByName(String name);

	/**
	 * 自定義預設的 Predicate 的處理規則
	 */
	@Override
	default void customize(final QuerydslBindings bindings, final QMailGroup qEntity)
	{
