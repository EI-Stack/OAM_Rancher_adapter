...
public interface ApmAlarmDao extends DaoBase<ApmAlarm, Long>, QuerydslBinderCustomizer<QApmAlarm>
{
	ApmAlarm findTopByAlarmId(String AlarmId);

	/**
	 * 自定義預設的 Predicate 的處理規則
	 */
	@Override
	default void customize(final QuerydslBindings bindings, final QApmAlarm qEntity)
	{
