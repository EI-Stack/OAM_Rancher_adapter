...
public interface MitigationDao extends DaoBase<Mitigation, Long>, QuerydslBinderCustomizer<QMitigation>
{
	 ...
	 */
	@Override
	default void customize(final QuerydslBindings bindings, final QMitigation qEntity)
	{
		// 自定義綁定關係，使用白名单模式 (true)，只有明確列出的欄位才適用於搜尋
		bindings.excludeUnlistedProperties(true);
		// 設置白名單
		bindings.including(qEntity.name, qEntity.detectionInterface);
		// 一次設定所有字串類型
